"""
Base settings for ifemun project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'ifemun.contrib.sites.migrations'
}
...
ADMINS = [
    ("""David Asamu""", 'davash001@gmail.com'),
]
...
SOCIALACCOUNT_ADAPTER = 'ifemun.users.adapters.SocialAccountAdapter'
